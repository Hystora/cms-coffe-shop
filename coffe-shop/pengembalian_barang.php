  ...
  <section class="hero">
    ...
    <div class="container">
      <main class="profile-content">
        ...
        <!-- Kanan: Konten Pengembalian Barang -->
        <div class="right-content">
          <div class="tabs">
            ...
            <a href="pengembalian_barang.php">
              <button class="active">Pengembalian Barang</button>
            </a>
          </div>
          ...
          <div class="order-list">
            ...
            <div class="order-item">
              ...
              <div class="order-details">
                ...
                <p class="order-status">Dikembalikan</p>
                <p class="order-total">Total Pengembalian Dana: <span>$000000</span></p>
              </div>
            </div>
            <div class="order-item">
              <div class="order-image">
