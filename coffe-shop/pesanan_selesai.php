...
<head>
  ...
  <link rel="stylesheet" href="public\css\pesanan_selesai.css" /> <!-- Penanda untuk link ke CSS khusus halaman ini -->
          ...
          <div class="right-content">
            <div class="tabs">
              ...
              <a href="pesanan_dikirim.php">
                <button>Dikirim</button> <!-- Penanda untuk tab pesanan dikirim -->
              </a>
              <a href="pesanan_selesai.php">
                <button class="active">Selesai</button> <!-- Penanda untuk tab pesanan selesai, aktif -->
              </a>
            ...
            <div class="order-list">
              <div class="order-item">
                ...
                <div class="order-details">
                  ...
                  <p class="order-status">Pesanan Selesai</p> <!-- Penanda untuk status pesanan -->
                  <p class="order-total">Total Pesanan: <span>$000000</span></p> <!-- Penanda untuk total pesanan -->
                  <button class="order-button">Beli Lagi</button> <!-- Penanda untuk tombol beli lagi -->
                </div>
              </div>
              <div class="order-item">
                <div class="order-image">
                ...
                <div class="order-details">
                  ...
                  <p class="order-status">Pesanan Selesai</p>
                  <p class="order-total">Total Pesanan: <span>$000000</span></p>
                  <button class="order-button">
                    <a href="deskripsi_produk.php">Beli Lagi</a> <!-- Penanda untuk link beli lagi -->
                  </button>
                </div>
              </div>
            </div>
