...
<head>
  ...
  <link rel="stylesheet" href="public\css\pesanan_dibatalkan.css" />
  ...
  <section class="hero">
    ...
    <div class="container">
      <main class="profile-content">
        ...
        <!-- Kanan: Konten Pesanan Dibatalkan -->
        <div class="right-content">
          <div class="tabs">
            ...
            <a href="pesanan_dibatalkan.php">
              <button class="active">Dibatalkan</button>
            </a>
          ...
          <div class="order-list">
            ...
            <div class="order-item">
              ...
              <div class="order-details">
                ...
                <p class="order-status">Dibatalkan</p>
                <p class="order-total">Total Pesanan: <span>$000000</span></p>
                <button class="order-button">
                  <a href="deskripsi_produk.php">Beli Lagi</a>
                </button>
              </div>
            </div>
